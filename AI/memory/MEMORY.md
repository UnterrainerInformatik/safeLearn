...
Echter Ablageort: `/home/psilo/source/htl/doc/safeLearn/AI/memory/`
...
- [Proposals-Intake](proposals-autostart.md) — `AI/proposals/` wird beim Session-Start **und bei jeder Frage nach neuer Arbeit** gelistet, Change heißt wie das File, beim Archivieren wandert es ins Change-Archiv
